...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
        {/* Background Image */}
        <img src={assets.bgImage} alt="backgroundImage" className='absolute top-0 left-0 -z-1 w-full h-full object-cover' />
        ...
        <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
          ...
          <div>
            ...
            <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-80 bg-clip-text text-transparent'>More than just friends truly connect</h1>
