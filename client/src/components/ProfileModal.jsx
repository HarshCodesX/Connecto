            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/profile relative'>
                                <img className='w-24 h-24 rounded-full object-cover mt-2' src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="profile_picture" />
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/cover relative'>
                                <img className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2' src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt="cover-photo" />
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your current location' onChange={(e) => setEditForm({...editForm, location: e.target.value})} value={editForm.location} />
                    </div>
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        {/* as we have already created a function that will run while submitting the form, therefore the type is "submit" here */}
