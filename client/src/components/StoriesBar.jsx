        ...
        <div className="flex gap-5 pb-5">
            ...
            {/* Story Card */}
            {
                stories.map((story, index) => (
                    <div className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`} key={index}>
