        ...
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {/* if user is not on others profile that means he is opening his profile so we will give edit button, and we will check it by checking the url, if url doesnt have any id, i.e user is checking his own profile */}
                    {!profileId && 
                        <button onClick={() => setShowEdit(true)} className='flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 cursor-pointer rounded-lg font-medium transition-colors mt-4 md:mt-0'>
